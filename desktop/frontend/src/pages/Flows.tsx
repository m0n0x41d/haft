      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm text-text-muted">
            Reusable flow schedules, a cross-project task board, and operator shortcuts anchored in the
            same desktop shell.
          </p>
        </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="max-h-[88vh] w-[840px] overflow-y-auto rounded-2xl border border-border bg-surface-1">
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          <div>
            <h3 className="text-lg font-semibold">{form.id ? "Edit Flow" : "New Flow"}</h3>
