...
3. **Start investigation** — If this is important:
   ```
   /q1-hypothesize "[topic]-related question"
   ```
...
Before: /q1-hypothesize "should we use Redis?"
Do:     /q-query redis
        /q-query caching
        /q-query session storage
