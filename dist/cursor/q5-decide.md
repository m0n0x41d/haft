...
## Context
The reasoning cycle is complete. We have audited hypotheses.

## Method (E.9 DRR)
1.  **Select:** Ask the user to pick the winning hypothesis (if not clear).
2.  **Draft DRR:** Construct the Design Rationale Record.
