...
func TestClassifyCommand(t *testing.T) {
	cases := []struct {
		...
		{"go test github.com/user/repo/pkg", "", false},
		{"go test -exec true ./...", "", false},
		{"go test -exec=true ./...", "", false},
		{"go test -coverpkg=github.com/user/repo/pkg ./...", "", false},
		{"go test -coverpkg ./internal/artifact ./...", "go test", true},
		{"go test ../other", "", false},
		...
		{"rg --pre ./script token internal/", "", false},
		{"rg --pre=./script token internal/", "", false},
		{"rg --pre-glob=md token internal/", "", false},
