...
// to the appropriate .haft/ subdirectory. Creates the directory if needed.
func WriteFile(haftDir string, a *Artifact) (string, error) {
	dir := filepath.Join(haftDir, a.Meta.Kind.Dir())
...
func writeFileQuiet(haftDir string, a *Artifact) {
	if _, err := WriteFile(haftDir, a); err != nil {
