		...
		},
		{
			...
			InputContract: interfaceContract{
				...
				Notes: []string{
					...
					"`selection_document_template` is a convenience packet, not approval; operator_approval_ref is empty until explicit operator approval.",
