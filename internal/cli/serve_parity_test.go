...
func TestTransportActionParity(t *testing.T) {
	cases := []struct {
		...
		{
			toolName:          "haft_query",
			mcpActions:        []string{"search", "status", "board", "related", "projection", "list", "coverage", "fpf", "spec_review", "spec_use", "change_case", "correspondence_graph", "drift_route", "evidence_path"},
