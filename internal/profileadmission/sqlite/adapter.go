...
func verifyCanonicalSchema(database *sql.DB) error {
	...
	statements := []string{
		...
		insertRevisionV3SQL,
		insertAdmissionV4SQL,
		insertAuthorityUseV4SQL,
		insertRevisionV4SQL,
		insertAdmissionV5SQL,
		insertAuthorityUseV5SQL,
		insertRevisionV5SQL,
...
func canonicalTransactionTriggers() []string {
	return []string{
		...
		"profile_initial_bootstrap_authority_bases_v1_exact_sources",
		"profile_initial_bootstrap_authority_resolutions_v1_exact_sources",
		"project_profile_admissions_v4_revision_cas",
		"project_profile_admissions_v4_exact_sources",
		"profile_declaration_authority_uses_v4_exact_sources",
		"project_profile_revisions_v4_exact_admission",
		"profile_initial_bootstrap_authority_bases_v1_no_update",
		"profile_initial_bootstrap_authority_bases_v1_no_delete",
		"profile_initial_bootstrap_authority_resolutions_v1_no_update",
		"profile_initial_bootstrap_authority_resolutions_v1_no_delete",
		"project_profile_admissions_v4_no_update",
		"project_profile_admissions_v4_no_delete",
		"profile_declaration_authority_uses_v4_no_update",
		"profile_declaration_authority_uses_v4_no_delete",
		"project_profile_revisions_v4_no_update",
		"project_profile_revisions_v4_no_delete",
		"profile_declaration_authority_bases_v5_exact_sources",
		"profile_declaration_authority_resolutions_v5_exact_sources",
		"project_profile_admissions_v5_revision_cas",
		"project_profile_admissions_v5_exact_sources",
		"profile_declaration_authority_uses_v5_exact_sources",
		"project_profile_revisions_v5_exact_admission",
		"profile_declaration_authority_bases_v5_no_update",
		"profile_declaration_authority_bases_v5_no_delete",
		"profile_declaration_authority_resolutions_v5_no_update",
		"profile_declaration_authority_resolutions_v5_no_delete",
		"project_profile_admissions_v5_no_update",
		"project_profile_admissions_v5_no_delete",
		"profile_declaration_authority_uses_v5_no_update",
		"profile_declaration_authority_uses_v5_no_delete",
		"project_profile_revisions_v5_no_update",
		"project_profile_revisions_v5_no_delete",
	}
}
...
func canonicalTransactionTables() []requiredTableSchema {
	return []requiredTableSchema{
		...
		{
			name: "profile_initial_bootstrap_authority_bases_v1",
			columns: []string{
				...
				"method_contract_ref", "method_contract_digest", "classifier_version",
				"policy_version", "suggestion_ref", "observation_digest",
		...
		{
			name: "profile_initial_bootstrap_authority_resolutions_v1",
			columns: []string{
				"authority_resolution_ref", "authority_resolution_digest",
				"authority_basis_ref", "authority_basis_digest", "project_root",
				"action_kind", "authority_mode", "resolution_kind", "profile_origin",
				"work_input_ref", "work_input_digest", "project_binding_digest",
				"detector_version", "detector_policy_version", "suggestion_ref",
				"observation_digest", "verifier_identity", "verifier_version",
				"verification_policy_ref", "verification_policy_digest", "checked_at",
				"currentness_result", "predicate_result", "admission_result",
				"canonical_json", "recorded_at",
			},
		},
		{
			name: "project_profile_admissions_v4",
			columns: []string{
				"admission_id", "action_kind", "project_root", "authority_mode",
				"resolution_kind", "profile_origin", "project_binding_digest",
				"work_input_ref", "work_input_digest", "profile_payload_json",
				"candidate_provenance_json", "candidate_provenance_digest",
				"profile_author_role_assignment_ref", "profile_author_role_assignment_digest",
				"profile_payload_digest", "observed_project_basis_ref",
				"observed_project_basis_digest", "work_record_ref", "work_record_digest",
				"outcome_assessment_ref", "outcome_assessment_digest", "authority_basis_ref",
				"authority_basis_digest", "authority_resolution_ref",
				"authority_resolution_digest", "receipt_json", "receipt_digest",
				"expected_ledger_revision", "ledger_revision", "single_use_key",
				"admission_request_digest", "admission_json", "admission_digest",
				"recorded_at",
			},
		},
		{
			name: "profile_declaration_authority_uses_v4",
			columns: []string{
				"use_ref", "use_digest", "project_root", "action_kind", "authority_mode",
				"resolution_kind", "profile_origin", "project_binding_digest",
				"authority_resolution_ref", "authority_resolution_digest",
				"authority_basis_ref", "authority_basis_digest", "work_input_ref",
				"work_input_digest", "single_use_key", "admission_request_digest",
				"committed_admission_ref", "committed_admission_digest", "canonical_json",
				"consumed_at", "recorded_at",
			},
		},
		{
			name: "project_profile_revisions_v4",
			columns: []string{
				"project_root", "ledger_revision", "configured_profile_kind",
				"profile_origin", "profile_payload_json", "profile_payload_digest",
				"receipt_json", "receipt_digest", "admission_id", "admission_digest",
				"recorded_at",
			},
		},
		{
			name: "project_profile_admissions_v5",
			columns: []string{
				"admission_id", "action_kind", "project_root", "authority_mode",
				"resolution_kind", "profile_origin", "project_binding_digest",
				"work_input_ref", "work_input_digest", "profile_payload_json",
		...
		{
			name: "profile_declaration_authority_uses_v5",
			columns: []string{
				"use_ref", "use_digest", "project_root", "action_kind", "authority_mode",
				"resolution_kind", "profile_origin", "project_binding_digest",
				"authority_resolution_ref", "authority_resolution_digest",
		...
		{
			name: "project_profile_revisions_v5",
			columns: []string{
				"project_root", "ledger_revision", "configured_profile_kind",
				"profile_origin", "profile_payload_json", "profile_payload_digest",
				"receipt_json", "receipt_digest", "admission_id", "admission_digest",
