...
type DraftInput = recordatconcern.PortfolioComparisonDraftInput
type Draft = recordatconcern.PortfolioComparisonDraft
type RecordDraftInput = recordatconcern.DraftInput

func NewDraft(input DraftInput) (Draft, error) {
	return recordatconcern.NewPortfolioComparisonDraft(input)
}
