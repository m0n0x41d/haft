...
type DraftInput = recordatconcern.SolutionPortfolioDraftInput
type Draft = recordatconcern.SolutionPortfolioDraft
type RecordDraftInput = recordatconcern.DraftInput

func NewDraft(input DraftInput) (Draft, error) {
	return recordatconcern.NewSolutionPortfolioDraft(input)
}
