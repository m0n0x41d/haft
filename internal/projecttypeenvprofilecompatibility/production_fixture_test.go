...
func TestProductionHistoricalToCurrentSuccessorKeepsInstalledProfilesCompatible(
	...
	historicalBaseRef := mustProductionProfileTest(
		typedmemory.ParseTypeEnvRef(basetypeenvartifacts.HistoricalV7Ref),
	)
	...
	priorSource := typedmemorycandidates.SourceV1_6()
	currentSource := typedmemorycandidates.SourceV1_7()
	...
	assertProductionCarrierBytesStable(
		t,
		"historical Local-Practice 1.6.0",
		priorSource,
		typedmemorycandidates.SourceV1_6(),
	)
	assertProductionCarrierBytesStable(
		t,
		"current Local-Practice 1.7.0",
		currentSource,
