...
| CL4a | ❌ | Any phase agent authoring or approving Haft TargetSystemSpec, SoftwareSystemSpec, TermMap, or SpecCoverage | **runtime-guard** | Spec authoring tools are not in Open-Sleigh phase toolsets. Open-Sleigh may consume spec refs carried by WorkCommission and may write RuntimeRun/PhaseOutcome/Evidence only. |
