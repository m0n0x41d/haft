...
sleigh_path="$tmp/sleigh.real-haft.md"
...
{
  "id": "wc-real-haft-smoke-001",
  "decision_ref": "dec-real-haft-smoke-001",
  "decision_revision_hash": "decision-r1",
  "problem_card_ref": "pc-real-haft-smoke-001",
  "implementation_plan_ref": "plan-real-haft-smoke-001",
  ...
  "scope": {
    "repo_ref": "local:haft",
    "base_sha": "base-r1",
    "target_branch": "feature/real-haft-smoke",
    "allowed_paths": ["**/*"],
    "forbidden_paths": [],
...
case "$runnable" in
  *'"commissions":[]'*)
    ;;
  *)
    echo "expected no runnable WorkCommissions after smoke" >&2
    exit 1
    ;;
esac
